...
export function DemoComputer(props) {
    ...
    const txt = useVideoTexture(props.texture ? props.texture : '/textures/project/project1.mp4') /* --->>> Se utliza para reemplazar la textura del monitor, pero en este modelo el monitor abarca más texturas por lo que solo lo dejamos de referencia. */
