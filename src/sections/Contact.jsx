...
const Contact = () => {
    ...
    const handleSubmit = async (event) => {
         /* Se instala la libreria de EmailJS que se encarga de enviar el formulario a tu email -> npm install @emailjs/browser*/ 
        event.preventDefault()

        try {
            console.log(import.meta.env.REACT_APP_EMAILJS_PUBLICKEY)
            await emailjs.send(
        ...
        <section className="c-space my-20" id="contact">
            <div className="relative min-h-screen flex items-center justify-center flex-col">
                ...
                <div className="contact-container">
                    <h3 className="head-text pt-7">Let's talk.</h3>
